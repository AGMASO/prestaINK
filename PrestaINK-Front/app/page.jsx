...
import ModalGetWeth from "./ui/modal-getWETH";
            ...
            <div className='flex flex-col w-[100%]'>
              <div className='flex justify-center items-center  mt-20'>
                <p className='line text-2xl text-white font-bold'>
                  To start the Protocol you need to deposit wETH
                </p>
              </div>
              <div className='flex justify-center  mt-20'>
                <p className='line text-2xl text-white font-bold pr-5'>
                  <ModalGetWeth></ModalGetWeth>
                </p>
                <p className='line text-2xl text-white font-bold pl-5'>

    ...
    <div className='min-h-[55vh] sm:min-h-[90vh]'>
      <div className=' flex justify-center items-center p-5'>
        <h1 className=' text-[6vw] text-center md:text-[65px] leading-1 select-none tracking-tightest font-extrabold'>
          <span
            data-content='Deposit Collateral in wETH or wBTC.'
          ...
          >
            <span className='px-2 text-transparent bg-clip-text bg-gradient-to-r from-gradient-1-start to-gradient-1-end animate-gradient-foreground-1'>
              Deposit Collateral in wETH.
            </span>
          </span>
          <span
            data-content='Mint Stablecoin pegged to USD.'
            className='relative block before:content-[attr(data-content)] before:w-full before:z-0 before:block before:absolute before:top-0 before:px-2 before:bottom-0 before:left-0 before:text-center before:text-[#0f1625] before:animate-gradient-background-2'
          >
            <span className='px-2 text-transparent bg-clip-text bg-gradient-to-r from-gradient-2-start to-gradient-2-end animate-gradient-foreground-2'>
              Mint Stablecoin pegged to USD.
            </span>
          </span>
          <span
            data-content='Get Paid.'
            className='relative block before:content-[attr(data-content)] before:w-full before:z-0 before:block before:absolute before:top-0 before:px-2 before:bottom-0 before:left-0 before:text-center before:text-[#0f1625] before:animate-gradient-background-3'
          >

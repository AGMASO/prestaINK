...
// import without using remmappings because of certora not able to read the path
...
contract DecentralizedStablecoin is ERC20Burnable, Ownable {
    ...
    /// @notice It will be pass OwnerShip to DSCEngine during Deployment time.
    constructor(address initialOwner) ERC20("PrestaInk", "PRINK") Ownable(initialOwner) {}
